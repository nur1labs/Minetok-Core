...
#this for core
#chmod
cd ~/coins/caicore/core && chmod 755 -R build-aux && chmod 755 -R depends && chmod 755 -R share && chmod 755 -R mubdi.sh
cd ~/coins/caicore/core && chmod 755 -R src/leveldb && chmod 755 -R src/univalue
#main
cd ~/coins/caicore/core && ./mubdi.sh && ./configure --enable-cxx --with-incompatible-bdb && make && make install
}
