...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef MUBDI_CHAINPARAMSSEEDS_H\n')
    g.write('#define MUBDI_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the mubdi network\n')
    ...
    g.write('#endif /* MUBDI_CHAINPARAMSSEEDS_H */')
