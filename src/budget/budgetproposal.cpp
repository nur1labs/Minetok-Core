...
bool CBudgetProposal::CheckStartEnd()
{
    ...
    bool fNewRules = Params().GetConsensus().NetworkUpgradeActive(nBlockStart, Consensus::UPGRADE_V5);
...
bool CBudgetProposal::UpdateValid(int nCurrentHeight)
{
    ...
    bool fNewRules = Params().GetConsensus().NetworkUpgradeActive(nCurrentHeight, Consensus::UPGRADE_V5);
