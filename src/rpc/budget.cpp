...
UniValue preparebudget(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 6)
        throw std::runtime_error(
            ...
            "5. \"address\":     (string, required) RCI address to send payments to\n"
...
UniValue getbudgetprojection(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) RCI address of payment\n"
            "    \"Ratio\": x.xxx,               (numeric) Ratio of yeas vs nays\n"
            "    \"Yeas\": n,                    (numeric) Number of yea votes\n"
            "    \"Nays\": n,                    (numeric) Number of nay votes\n"
            "    \"Abstains\": n,                (numeric) Number of abstains\n"
            "    \"TotalPayment\": xxx.xxx,      (numeric) Total payment amount in RCI\n"
            "    \"MonthlyPayment\": xxx.xxx,    (numeric) Monthly payment amount in RCI\n"
            ...
            "    \"Allotted\": xxx.xxx,           (numeric) Amount of RCI allotted in current period\n"
            "    \"TotalBudgetAllotted\": xxx.xxx (numeric) Total RCI allotted\n"
            "  }\n"
            "  ,...\n"
            "]\n"
