...
public:
    CTxMemPoolEntry(const CTransactionRef& _tx, const CAmount& _nFee,
            int64_t _nTime, double _entryPriority, unsigned int _entryHeight, CAmount _inChainInputValue, 
...
public:
    ...
    void ApplyDelta(const uint256& hash, double& dPriorityDelta, CAmount& nFeeDelta) const;
