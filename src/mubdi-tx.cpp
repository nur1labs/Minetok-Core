...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " mubdi-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  mubdi-tx [options] <hex-tx> [commands]  Update hex-encoded mubdi transaction\n" +
                               "or:     mubdi-tx [options] -create [commands]   Create hex-encoded mubdi transaction\n" +
                               "\n";
