...
static const std::string addr1 = "mubi8XAE1rcdCQfkv9w22n8Y9RxgaJnrDD";
static const std::string addr2 = "mubKfv1FVp69yZMDzeuugvfZ9pzYiMv1bs";
static const std::string addr1C = "mubrHK9ezAAUVExFDpZ7EE1xWpPskgp1gP";
static const std::string addr2C = "mubVSAoc2whPFjZVAZ1pQbXPJk1LRrDC8Q";
