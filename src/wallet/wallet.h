...
enum WalletFeature {
    ...
    FEATURE_PRE_MUBDI = 64000, // inherited version..
    ...
    FEATURE_SAPLING = 180000, // Upgraded to Blockstream key manager.
...
private:
    ...
    */
    ...
    void ChainTipAdded(const CBlockIndex *pindex, const CBlock *pblock);
...
public:
     ...
     * MuBdI: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
