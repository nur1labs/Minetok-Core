    ...
    ui(new Ui::SettingsMubToolWidget)
{
    ...
    connect(ui->pushButtonDecrypt, &QPushButton::clicked, this, &SettingsMubToolWidget::onDecryptClicked);
    connect(ui->pushButtonImport, &QPushButton::clicked, this, &SettingsMubToolWidget::importAddressFromDecKey);
    connect(btnContact, &QAction::triggered, this, &SettingsMubToolWidget::onAddressesClicked);
    connect(ui->pushButtonClear, &QPushButton::clicked, this, &SettingsMubToolWidget::onClearAll);
    connect(ui->pushButtonDecryptClear, &QPushButton::clicked, this, &SettingsMubToolWidget::onClearDecrypt);
}
