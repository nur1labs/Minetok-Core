...
{
    if (NetworkUpgradeActive(nHeight, consensus, Consensus::UPGRADE_V5)) {
        return CBlockHeader::CURRENT_VERSION;       // v11 (since 5.2.99)
    } else if (consensus.NetworkUpgradeActive(nHeight, Consensus::UPGRADE_V4)) {
        return 7;
    } else if (consensus.NetworkUpgradeActive(nHeight, Consensus::UPGRADE_V3)) {
        return 6;
