...
#ifndef MUBDI_SCRIPT_ISMINE_H
#define MUBDI_SCRIPT_ISMINE_H
...
enum isminetype {
    ...
    ISMINE_SPENDABLE_NO_DELEGATED =  ISMINE_SPENDABLE,
    ISMINE_SPENDABLE_ALL = ISMINE_SPENDABLE_DELEGATED | ISMINE_SPENDABLE,
    ISMINE_WATCH_ONLY_ALL = ISMINE_WATCH_ONLY,
