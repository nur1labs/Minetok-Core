...
const unsigned char MUBDI_PREVOUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'M','u','B','d','I','P','r','e','v','o','u','t','H','a','s','h'};
const unsigned char MUBDI_SEQUENCE_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'M','u','B','d','I','S','e','q','u','e','n','c','H','a','s','h'};
const unsigned char MUBDI_OUTPUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'M','u','B','d','I','O','u','t','p','u','t','s','H','a','s','h'};
const unsigned char MUBDI_SHIELDED_SPENDS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'M','u','B','d','I','S','S','p','e','n','d','s','H','a','s','h'};
const unsigned char MUBDI_SHIELDED_OUTPUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'M','u','B','d','I','S','O','u','t','p','u','t','H','a','s','h'};
...
uint256 SignatureHash(const CScript& scriptCode, const CTransaction& txTo, unsigned int nIn, int nHashType, const CAmount& amount, SigVersion sigversion, const PrecomputedTransactionData* cache)
{
    ...
    if (sigversion == SIGVERSION_SAPLING) {
        ...
        memcpy(personalization, "MuBdISigHash", 12);
