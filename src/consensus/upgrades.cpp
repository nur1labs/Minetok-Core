...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
        {
                /*.strName =*/ "Base",
                /*.strInfo =*/ "MuBdI network",
        },
        {
                /*.strName =*/ "Start_Hybrid",
                /*.strInfo =*/ "Start Hybrid activation height",
        },
        {
                /*.strName =*/ "PoS",
        ...
        {
                /*.strName =*/ "MuBdI_v2",
                /*.strInfo =*/ "New blockstream network added ArIn",
        },
        {
                /*.strName =*/ "MuBdI_v3",
                /*.strInfo =*/ "New blockstream network added LiEsE",
        },
        {
                /*.strName =*/ "MuBdI_v4",
                /*.strInfo =*/ "New blockstream network added LeVi",
        },
        {
                /*.strName =*/ "MuBdI_v5",
                /*.strInfo =*/ "New blockstream network added MiRa",
        },
        {
                /*.strName =*/ "MuBdI_v6",
                /*.strInfo =*/ "New blockstream network added AkIo",
        },
        {
                /*.strName =*/ "Test_dummy",
