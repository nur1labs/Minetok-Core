...
struct Params {
    ...
    bool IsTimeProtocolV2(const int nHeight) const { return NetworkUpgradeActive(nHeight, UPGRADE_V4); }
            ...
            const int utxoFromBlockHeight, const uint32_t utxoFromBlockTime) const
    {
        ...
        if (!NetworkUpgradeActive(contextHeight, Consensus::UPGRADE_V3))
